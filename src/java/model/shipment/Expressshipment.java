...
public class Expressshipment implements Serializable {
    ...
    public Expressshipment(Integer shipmentId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Expressshipment)) {
            return false;
        }
        Expressshipment other = (Expressshipment) object;
    ...
    public String toString() {
        return "model.Expressshipment[ shipmentId=" + shipmentId + " ]";
    }
